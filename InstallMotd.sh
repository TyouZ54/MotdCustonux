...
wget https://raw.githubusercontent.com/TyouZ54/MotdCustonux/main/Content1 -O /etc/update-motd.d/00-motd
wget https://raw.githubusercontent.com/TyouZ54/MotdCustonux/main/Content2 -O /etc/update-motd.d/10-motd
